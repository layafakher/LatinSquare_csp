...
class MinConflictSolution(solution):
    def __init__(self, steps=1000):
        super().__init__()
        self._steps = steps

    def get_description(self):
        return "Minimum Conflicts solution : "
        ...
        for _ in range(self._steps):
            ...
            for variable in lst:
                ...
                for constraint, variables in vconstraints[variable]:
                    ...
                    continue
                # Node has conflicts. Find values with less conflicts.
...
class backtracking_solution(solution):
    def __init__(self, forwardcheck=True):
        super().__init__()
        self._forward_check = forwardcheck

    def get_description(self):
        return "Recursive Backtracking solution with Forward check = %s :" % self._forward_check

    def backtracking_solution(self, solutions, domains, vconstraints, assignments, single):
        ...
        for value in domains[variable]:
            ...
            for constraint, variables in vconstraints[variable]:
                ...
                self.backtracking_solution(solutions, domains, vconstraints, assignments, single)
    ...
    def get_solution(self, domains, constraints, vconstraints):
        self.counter = 0
        solutions = self.backtracking_solution([], domains, vconstraints, {}, False)
